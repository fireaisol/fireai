...
from fire.agents.stream import PLUGIN_CN, get_plugin_prompt
from fire.distributed import AsyncHTTPAgentClient, AsyncHTTPAgentServer, HTTPAgentClient, HTTPAgentServer
...
server = HTTPAgentServer(
    '1',
    {
        'type': 'fire.agents.AsyncAgent',
        'llm': {
            'type': 'fire.llms.AsyncLMDeployPipeline',
...
server = AsyncHTTPAgentServer(
    '1',
    {
        'type': 'fire.agents.AsyncMathCoder',
        'llm': {
            'type': 'fire.llms.AsyncLMDeployPipeline',
            'path': 'fire/fire2_5-7b-chat',
            'meta_template': fire2_META,
        ...
        'interpreter': {
            'type': 'fire.actions.AsyncIPythonInterpreter',
            'max_kernels': 100
        },
    },
    port=8091,
...
server_cfg = dict(
    type='fire.distributed.AsyncHTTPAgentServer',
    gpu_id='1',
    config={
        'type': 'fire.agents.AsyncAgentForfire',
        'llm': {
            'type': 'fire.llms.AsyncLMDeployPipeline',
            'path': 'fire/fire2_5-7b-chat',
            'meta_template': fire2_META,
        ...
        'plugins': plugins,
        'output_format': {
            'type': 'fire.prompts.parsers.PluginParser',
            'template': PLUGIN_CN,
