...
from fire.agents.stream import AsyncAgentForfire, AsyncMathCoder
from fire.llms import fire2_META
from fire.llms.vllm_wrapper import AsyncVllmModel
from fire.prompts.parsers import ToolParser
...
coder = AsyncMathCoder(
    llm=model,
    interpreter=dict(
        type='fire.actions.AsyncIPythonInterpreter', max_kernels=200),
