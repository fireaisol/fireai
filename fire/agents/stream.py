...
from fire.actions import ActionExecutor, AsyncActionExecutor, AsyncIPythonInterpreter, IPythonInteractive
from fire.agents.agent import Agent, AsyncAgent
from fire.agents.aggregator import fireToolAggregator
from fire.hooks import fireActionProcessor
from fire.llms import BaseLLM
from fire.memory import Memory
from fire.prompts.parsers import InterpreterParser, MixedToolParser, PluginParser, ToolStatusCode
from fire.schema import AgentMessage
from fire.utils import create_object
...
class AgentForfire(Agent):
    ...
    def __init__(
        ...
        aggregator: Dict = dict(type=fireToolAggregator),
        action_hooks: List = [dict(type=fireActionProcessor)],
...
class AsyncAgentForfire(AsyncAgent):
...
class AsyncMathCoder(AsyncAgentForfire):
