...
from fire.actions import ActionExecutor, AsyncActionExecutor, BaseAction
from fire.agents.agent import Agent, AsyncAgent
from fire.agents.aggregator import DefaultAggregator
from fire.hooks import ActionPreprocessor
from fire.llms import BaseLLM
from fire.memory import Memory
from fire.prompts.parsers.json_parser import JSONParser
from fire.prompts.prompt_template import PromptTemplate
...
if __name__ == '__main__':
    ...
    from fire.llms import GPTAPI, AsyncGPTAPI
    ...
    agent = ReAct(
        ...
        output_format=output_format,
        aggregator=dict(type='fire.agents.aggregator.DefaultAggregator'),
        actions=[dict(type='fire.actions.PythonInterpreter')],
    )
    ...
    async_agent = AsyncReAct(
        ...
        output_format=output_format,
        aggregator=dict(type='fire.agents.aggregator.DefaultAggregator'),
        actions=[dict(type='fire.actions.AsyncPythonInterpreter')],
    )
