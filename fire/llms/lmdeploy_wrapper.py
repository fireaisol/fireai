...
from fire.llms.base_llm import AsyncLLMMixin, BaseLLM
from fire.schema import ModelStatusCode
from fire.utils.util import filter_suffix
        ...
        path (str): The path to the model.
            It could be one of the following options:
                    ...
                    - ii) The model_id of a lmdeploy-quantized model hosted
                        ...
                        "fire/fire-chat-20b-4bit",
                        "lmdeploy/llama2-chat-70b-4bit", etc.
                    - iii) The model_id of a model hosted inside a model repo
                        on huggingface.co, such as "fire/fire-chat-7b",
                        "Qwen/Qwen-7B-Chat ", "baichuan-inc/Baichuan2-7B-Chat"
                        and so on.
        model_name (str): needed when model_path is a pytorch model on
            huggingface.co, such as "fire-chat-7b",
